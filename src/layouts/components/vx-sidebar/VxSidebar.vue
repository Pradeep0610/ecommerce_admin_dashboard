        ...
        <div @mouseenter="sidebarMouseEntered" @mouseleave="sidebarMouseLeave">
            <div class="header-sidebar flex items-end justify-between" slot="header">
                <div class="logo flex items-center">
                    ...
                    <span class="logo-text text-primary" v-show="isMouseEnter || !reduce" v-if="title">{{ title }}</span>
                </div>
                <div>
              ...
              -->
                        <!-- Ditambah Brian ubah warna sesuai theme (menambah text-primary) -->
                        <feather-icon icon="ChevronsLeftIcon" class="mr-0 cursor-pointer" svg-classes="stroke-current text-primary" v-show="!reduce" @click="toggleReduce(true)" id="btnSidebarToggler"></feather-icon>
                        <feather-icon icon="ChevronsRightIcon" class="mr-0 cursor-pointer" svg-classes="stroke-current text-primary" v-show="reduce" @click="toggleReduce(false)" id="btnSidebarToggler"></feather-icon>
                    </template>
                </div>
            </div>
