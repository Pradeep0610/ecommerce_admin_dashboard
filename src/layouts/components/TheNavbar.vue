            ...
            <vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer">
                ...
                <vs-dropdown-menu class="cart-dropdown" :class="{'dropdown-custom': cartItems.length}">
                    ...
                    <template v-if="cartItems.length">
                        ...
                        <div class="checkout-footer fixed pin-b rounded-b-lg text-primary font-semibold w-full p-2 text-center border border-b-0 border-l-0 border-r-0 border-solid border-grey-light cursor-pointer" @click="$router.push('/apps/eCommerce/checkout')">
                ...
                <vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer">
                    ...
                    <vs-dropdown-menu>
                        <ul style="min-width: 9rem">
                            ...
                            <li class="flex py-2 px-4 cursor-pointer hover:bg-primary hover:text-white" @click="$router.push('/apps/eCommerce/wish-list')">
